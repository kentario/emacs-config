...
(custom-set-faces
 ...
 '(lazy-highlight ((t (:foreground "#8ae4f2"
				   :background "#004065"))))
 '(isearch ((t (:foreground "white"
			    :background "#2f822f"
			    :weight bold))))
 '(font-lock-comment-face ((t (:foregrounnd "#73d216")))) ;comments (this)
 '(font-lock-preprocessor-face ((t (:foreground "CornFlowerBlue")))) ;#include, #define
 '(font-lock-type-face ((t (:foreground "SteelBlue1")))) ; variable type
 ;; '(font-lock-keyword-face ((t (:foreground "SteelBlue1")))) ; template, class, private, public, for, if ...
 )
